...
namespace PE.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(shopPEContext context)
        {
            _context = context;
        }
        ...
        {
            //get data from db to push to view
            ViewData["Role"] = new SelectList(_context.Roles, "RoleId", "Description");


            //create list data to push to view
            ...
            var shopPEContext = _context.Accounts.Include(a => a.Role);
